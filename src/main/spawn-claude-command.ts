...
// Moved to src/shared/shell-quote.ts (shared with provider core); re-exported
// here so every existing import of quoteArgForShell keeps working.
export { quoteArgForShell }
