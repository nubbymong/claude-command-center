...
export const changelog: ChangelogEntry[] = [
  {
    version: '2.1.0-rc.15',
    date: '2026-09-05',
    highlights: 'Two fixes from the rc.14 feedback. The in-app browser pane no longer sits in front of a page tab: open claude.ai artifacts in the pane, then open Settings, and Settings is what you see. And the Sign-in browser choice for an SSO account (Edge or Chrome) is back on managed machines where Chrome is installed just for you rather than for everyone.',
    changes: [
