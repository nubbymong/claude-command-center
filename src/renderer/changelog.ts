...
export const changelog: ChangelogEntry[] = [
  {
    ...
    changes: [
      ...
      { type: 'feature', description: "Live Activity feed. Footer on every terminal session expands into a timeline of recent hook events with Pause/Resume, type filters, and collapsed summary. Ring-buffered to 200 events per session" },
