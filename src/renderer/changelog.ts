...
export const changelog: ChangelogEntry[] = [
  {
    ...
    changes: [
      ...
      { type: 'improvement', description: 'A container session says so. A small teal container mark sits on the session card and in the session header, with the container name on hover. It reads alongside the SSH marks rather than replacing them, so a persistent remote session in a container wears all three.' },
