...
export const changelog: ChangelogEntry[] = [
  {
    ...
    changes: [
      ...
      { type: 'feature', description: 'Hello Codex: a five-page introduction to Codex in this app, shown once when Codex is on and a Codex account you added is signed in. Replay it from Show the Codex introduction on the Codex card in the Feature Guide, or on the Codex row in Settings, Accounts.' },
