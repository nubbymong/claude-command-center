...
> **Beta** — Installers are unsigned. Windows SmartScreen will warn on first run.
> Click **"More info"** then **"Run anyway"** to proceed. macOS: right-click the app and select **Open**.
