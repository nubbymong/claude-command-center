...
> A maintenance release: the runtime and its dependencies refreshed, the open security-scanner findings resolved, and the largest source files split into focused modules with no change in behaviour.
